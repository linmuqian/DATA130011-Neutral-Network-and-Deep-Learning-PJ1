...
train_images_path = r'.\codes\dataset\MNIST\train-images-idx3-ubyte-augmented.gz'
train_labels_path = r'.\codes\dataset\MNIST\train-labels-idx1-ubyte-augmented.gz'
...
save_dir = r'./codes/best_models/model_mlp_4'
